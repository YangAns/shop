    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                ...
                <button class="layui-btn layui-btn-sm" lay-event="back"><i
                        class="layui-icon layui-icon-return"></i>返回一级分类
                </button>
            </div>
        </script>
        <%-- 表格区域 --%>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        var tableIns = table.render({
            elem: '#currentTableId',
            url: '${ctx}/admin/goodstype/list?pid='+${pid},
            toolbar: '#toolbarDemo',
            cols: [[
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            if (obj.event === "add") {
                ...
                window.location.href="${ctx}/admin/toGoodsTypeOneManager"
            }
        });
